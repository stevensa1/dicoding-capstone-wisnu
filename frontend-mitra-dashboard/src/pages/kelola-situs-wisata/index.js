                            ...
                            <div className='ml-2'>
                                <p
                                    className={`text-sm text-gray-500 ${
                                        textData &&
                                        textData[index] &&
                                        textData[index].fontSize
                                            ? `text-${textData[index].fontSize}`
                                            : ''
                                    } ${
                                        textData &&
                                        textData[index] &&
                                        textData[index].fontFamily
                                            ? `font-${textData[index].fontFamily}`
                                            : ''
                                    }`}
                                >
    ...
    const BoxLinks = () => {
        return (
            <div className='text-red-500 hover:text-red-700 p-4'>
                <a
                    href='#'
                    className='text-red-500 hover:text-red-700 block mb-2'
                >
